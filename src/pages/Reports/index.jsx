...
import { getWeekNumber } from '../../utils/week_helper'; // ← tambahkan ini
                ...
                <div>
                  ...
                  <input type="date" value={selectedDate}
                    onChange={(e) => { setSelectedDate(e.target.value); 
                      handleFilter({ reportType, selectedDate: e.target.value, selectedMonth, selectedYear, selectedWeek });
                    }}
                    className="input" />
                </div>
              )}
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      handleFilter({
                        ...
                        selectedMonth,
                        selectedYear,
                        selectedWeek: e.target.value, // ← nilai baru langsung dari input
                      });
                    }}
                    className="input"
                  />
